...
class Information(Enum):
    ...
    FILE_WITH_MAPPED_RESEARCH_INTEREST = "mapping_combined.csv"
...
class DatabaseResetService:
    ...
    def recreate_db(self, person_json, similarity_json, pickle_file_name):
        ...
        if (
            InitialCheckup.check_for_file_availability(person_json_path) == 0
            and InitialCheckup.check_for_file_availability(similarity_json_path) == 0
            and InitialCheckup.check_for_file_availability(pickle_file_path) == 0
            and InitialCheckup.check_for_file_availability(file_path_with_mapped_research_interest) == 0
        ):
